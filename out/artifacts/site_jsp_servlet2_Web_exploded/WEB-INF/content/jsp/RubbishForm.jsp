                        ...
                        <div class="mdl-card mdl-shadow--6dp">
                            ...
                            <div class="mdl-card__supporting-text">
                                <c:if test="${rubbish != null}">
                                    <form name="form" action="${pageContext.request.contextPath}/update" method="post" onsubmit="return validateForm()"></form>
                                </c:if>
                                <c:if test="${rubbish == null}">
                                    <form name="form" action="${pageContext.request.contextPath}/insert" method="post" onsubmit="return validateForm()">
                                        <c:if test="${rubbish != null}">
                                        ...
                                        <div>
                                            <c:choose>
                                                <c:when test="${rubbish != null}">
                                                    <input class="mdl-textfield__input" type="text" name="quantity" <%--value="rubbish.quantity"--%> id="quantity"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <input class="mdl-textfield__input" type="text" name="quantity" <%--value="1"--%> id="quantity"/>
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield">
                                            <input class="mdl-textfield__input" type="text" name="location" <%--value="Location"--%> id="location"/>
